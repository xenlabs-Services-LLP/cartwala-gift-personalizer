(()=>{
  ...
  document.addEventListener('cartwala:cart-complete',()=>{cartConfirmed=true});
  document.addEventListener('cartwala:item-added',()=>{cartConfirmed=true;paint(Math.max(progress,96))});
