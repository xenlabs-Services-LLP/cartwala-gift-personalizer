...
const targets = [
  {
    handle: "personalized-photo-mug-normal-white-11-oz",
  ...
  {
    handle: "personalized-magic-mug-hot-water-reveal-11-oz",
  ...
  {
    handle: "personalized-white-love-handle-mug-11-oz",
  ...
  {
    handle: "personalized-inner-colour-red-mug-11-oz",
